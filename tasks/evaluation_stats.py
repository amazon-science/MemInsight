...
if __name__ == "__main__":
    ...
    analyze_aggr_acc('/Users/ranasal/Downloads/AmazonBedrockAgentsAutonomousMemAugInternship/QA and ES/locomo/data/locomo10.json', '/Users/ranasal/Downloads/AmazonBedrockAgentsAutonomousMemAugInternship/QA and ES/locomo/data/locomo10_aug_sonnet_embeddings_diag_ann_k5_ordered_att.json',
            '/Users/ranasal/Downloads/AmazonBedrockAgentsAutonomousMemAugInternship/QA and ES/locomo/data/locomo10_aug_sonnet_embeddings_diag_ann_k5_ordered_att_stats.json'
            ,'aug_aug_models_top_5',
            'aug_aug_models_top_5_f1',
            rag=False
            )