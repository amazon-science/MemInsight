...
def rougel_score(prediction, ground_truth):
    ...
    except Exception:  # "Hypothesis is empty."
        print('Exception received for: ',prediction,ground_truth)
        return 0,0,0,{}

    return scores["rouge-1"]["f"],scores["rouge-2"]["f"],scores["rouge-l"]["f"],scores
